        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            <motion.h1
              ...
              className="font-heading text-5xl md:text-7xl tracking-wide lowercase text-foreground mb-8"
            >
              Let's Connect
            </motion.h1>
            <motion.p
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-foreground focus:outline-none focus:border-foreground/50 transition-colors"
                  >
            ...
            >
              <div>
                <h2 className="font-heading text-2xl tracking-wide lowercase text-foreground mb-4">Direct Contact</h2>
                <a
                  href="mailto:hello@davidpblake.org"
                  className="font-body text-lg md:text-xl tracking-widest lowercase text-foreground hover:text-muted-foreground transition-colors block mb-8"
                >
              ...
              <div>
                <h2 className="font-heading text-2xl tracking-wide lowercase text-foreground mb-4">Follow</h2>
              ...
              <div>
                <h2 className="font-heading text-2xl tracking-wide lowercase text-foreground mb-4">Studio Locations</h2>
